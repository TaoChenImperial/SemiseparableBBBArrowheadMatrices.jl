...
\begin{align*}
    ...
    &\quad + \mathbf{d}_1 \bar{\mathbf{u}}_1^\top \mathbf{y}^{(1)} - \tau \mathbf{d}_1 \bar{\mathbf{u}}_1^\top \mathbf{c}_5 + \mathbf{z}^{(1)} - \tau \mathbf{c}_6)[2:\min(\ell+m+1, n)], \\
    ...
    &\quad + \mathbf{x}^{(1)} - \tau \mathbf{c}_4 + \bar{\mathbf{w}}_1 \bar{\mathbf{u}}_1^\top \mathbf{y}^{(1)}  - \tau \bar{\mathbf{w}}_1 \bar{\mathbf{u}}_1^\top \mathbf{c}_5) \in \mathbb{R}^p, \\
    \hat{\boldsymbol{\beta}} &= (-\tau \bar{\mathbf{k}} + K^\top \bar{\mathbf{u}}_1 - \tau \mathbf{c}_2 + \mathbf{y}^{(1)} - \tau \mathbf{c}_5) \in \mathbb{R}^r.
\end{align*}
...
\begin{align*}
    ...
    \tilde{\boldsymbol{\beta}} &= (-\tau \bar{\mathbf{k}} + K^\top \bar{\mathbf{u}}_1 - \tau \mathbf{c}_2 + \mathbf{y}^{(1)} - \tau \mathbf{c}_5) \in \mathbb{R}^r.
\end{align*}
...
\begin{theorem}
Algorithm~\ref{algo_applyQ}  computes \( \mathbf{c} = Q^T\mathbf{b} \) in \( O(n) \) operations.
\end{theorem}
