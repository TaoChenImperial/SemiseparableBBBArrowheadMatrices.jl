...
\[
(I - \tau_k \bfy_k \bfy_k^\top) \cdots (I - \tau_1 \bfy_1 \bfy_1^\top) A = \begin{bmatrix}
r_{11} & r_{12} & r_{13} & \cdots & r_{1,n-2} & r_{1,n-1} & r_{1n} \\
 & r_{22} & r_{23} & r_{24} & \cdots & r_{2,n-1}  & r_{2n} \\
...
F_k = \begin{bmatrix}
r_{11} & r_{12} & r_{13} & \cdots & r_{1,n-2} & r_{1,n-1} & r_{1n} \\
y_{21} & r_{22} & r_{23} & r_{24} & \cdots & r_{2,n-1}  & r_{2n} \\
...
The first step is to understand the structure of the Householder reflector, which corresponds to the $k+1$-th column of $F_{k+1}$:

\begin{lemma}
    Suppose $F_k$ has the prescribed form. Then
\[
F_{k+1} \bfe_{k+1} = 
\]
\end{lemma}
